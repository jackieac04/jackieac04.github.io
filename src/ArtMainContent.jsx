  ...
  return (
    ...
    <div className='main'>
        ...
        <div className='awards'>
            <h2>Awards</h2>
            <ul>
            <li>My Impact Challenge <span className='center'>Honorable Mention Scholarship</span> <span>2022</span></li> <br />
            <li> Scholastic Art Awards <span className='center'>Gold Key and Portfolio</span>  <span>7x, 2020-2022</span></li> <br />
            <li>Scholastic American Visions Nominee <span className='center'>1</span><span>2022</span></li> <br />
            <li>Women In the Visual Arts <span className='center'>Honorable Mention</span><span>2022</span></li>
            </ul>
        </div>
        <div className='pubs features'>
            <p>
                ...
                <a href="https://www.dsoaseeds.com/surge">Surge Literary Arts Magazine</a> <br />
            ...
            <h2>Publications, Features, and Exhibitions</h2>
            <br />
            <br />
        </div>
    </div>
