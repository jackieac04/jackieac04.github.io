...
export default function Home() {
  return (
    ...
    <div className='home-container'>
        <img className="home" src=".https://github.com/jackieac04/jackieac04.github.io/blob/main/src/assets/images/HomePage.png" alt="A digital painting of a girl looking down a well. She is surrounded by plants and animals. Halfway down the well, text reads: About Me. 
        ...
        <img className='butterfly-gif' src="https://github.com/jackieac04/jackieac04.github.io/blob/main/src/assets/images/butterflies.gif" alt="an animation of two butterflies flying in opposite directions across the screen" />
    </div>
  )
}
